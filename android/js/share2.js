...
var id=$(temp).attr("productId");
var memberId = getCookie("id");

var url = "http://h5.izhenpinwang.com:8084?id="+id+"&memberId="+memberId;
var cover = "";
var commodity_name = "商品名称";
var commodity_link = "";
var sharehrefDes = "【臻品商城】App 向你推荐一件超赞的商品，你一定喜欢！@你";

function toshare2(temp) {
	$.ajax({
		url: getCookie("tempUrl") + "/commodity/getInfo.do?token=" + getCookie("token") + "&id="+id,
		type: "GET",
		success: function(result) {
			if(result.code == 0) {
				...
				id = obj.id;
				cover = obj.cover;
				commodity_name = obj.commodityName;
				commodity_link = obj.commodityLink;

			}
		}
	});
	$.ajax({
		url: getCookie("tempUrl") + "/newShare/commodityShare.do?token=" + getCookie("token") + "&commodityId=" + id,
		type: "POST",
		success: function(result) {
			if(result.code == 0) {
				//url = result.data;
...
function shareweixin1() {
	...
	shareAction(sb, true, msg);
//	var msg = {
//		content: commodity_name+"网址"+url
//	};
//	shareSystem(msg);
}

//分享到朋友圈
function shareweixin2() {
	var ss = shares['weixin'];
	var sb = {
		s: ss,
		x: 'WXSceneTimeline'
...
function sina() {
	...
	var msg = {
		content: commodity_name + url +"&shareWay=3"
//		extra: {
//			scene: sb.x
//		},
//		href: url,
...
//分享到新浪微博
//$("#sina").click(function(title, url, picurl) {
//	var _shareUrl = 'http://v.t.sina.com.cn/share/share.php?&appkey=895033136'; //真实的appkey，必选参数
//	var _url = url;
//	var _title = commodity_name;
//	var _source = "";
//	var _sourceUrl = "";
//	var _pic = cover;
//	var _width = "";
