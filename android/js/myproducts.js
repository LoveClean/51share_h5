...
$(function() {
	$.ajax({
		url: getCookie("tempUrl") + "/commodity/getCommodityGroupByTypeId?token=" + getCookie("token") + "&memberId=" + getCookie("id") + "&pageNum=1&pageSize=99",
		type: "GET",
...
function back() {
	...
	function getListDataFromNet(pdType, pageNum, pageSize, successCallback, errorCallback) {
		...
		setTimeout(function() {
			$.ajax({
				type: 'GET',
				url: getCookie("tempUrl") + "commodity/getCommodityGroupByTypeId?pageNum=1&pageSize=22&token=" + getCookie("token") + "&memberId=" + getCookie("id"),
