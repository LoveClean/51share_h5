...
//			http://share-app.oss-cn-qingdao.aliyuncs.com/20180523138842b0fb-c328-4f4e-9999-1b53755eeabd.jpg
	...
	function getListDataFromNet(pdType, pageNum, pageSize, successCallback, errorCallback) {
		...
		setTimeout(function() {
			$.ajax({
				type: 'GET',
				url: getCookie("tempUrl") + '/article/getAllByStatus?pageNum=1&pageSize=11&token=' + getCookie("token"),
...
//function ShareFlas() {
//  $.ajax({
//      url:  getCookie("tempUrl")+"common/audit",
//      type: "GET",
//      success: function (result) {
//         	if (!result) {
//	   			$(".icon_share").attr("style","display: none;");
//	   			$(".article_yong").attr("style","display: none;");
//	   		}
//      }
//  });
//};
