...
$(function() {
	...
	function setListData(curPageData) {
		...
		for(var i = 0; i < curPageData.length; i++) {
			...
			var div3 = $("<div class='price'></div>").append(
				"<span>价格：<span style='color:#F9DC86;'>" + item.commodityPrices 
				+"</span></span><span>&nbsp / &nbsp奖励：<span style='color:#F9DC86;'>"
				+ yong + "</span></span>");
	...
	function getListDataFromNet(pdType, pageNum, pageSize, successCallback, errorCallback) {
		...
		setTimeout(function() {
			$.ajax({
				type: 'GET',
				url: getCookie("tempUrl") + 'commodity/getAllByStatus.do?token=' + getCookie("token") + "&pageNum=1&pageSize=999",
